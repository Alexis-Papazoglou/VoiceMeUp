...
function App() {
  ...
  function handleClickGenerateTTS() {
    if (!model) {
  ...
  function handleClickGenerateTTSVoice() {
    if (!model) {
      alert("Please select a model first!");
      return;
    }
    generateTTSfromVoice();
  }
    ...
    <div className="App">
      ...
      <div className="form-input">
        {modelList.length === 0 ? (
          <div>
            <p>
              The API is deployed on render so it might take some time until the
      ...
      <div>
        <div className="btn-container">
          <button
            onClick={handleClickGenerateTTS}
          ...
          <button
            onClick={handleClickGenerateTTSVoice}
            disabled={isTextUsed}
